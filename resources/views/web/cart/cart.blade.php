    ...
    <div class="container">
        <div class="breadcrumb-sec-content">
            ...
            <nav class="text-dark d-flex justify-content-center breadcrumb-divider" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item {{ session()->get('direction') == 'rtl' ? 'breadcrumb-item-rtl ps-0' : '' }}">
                        <a class="text-muted" href="{{ route('home') }}">{{ trans('labels.home') }}</a>
                    </li>
                    <li class="breadcrumb-item {{ session()->get('direction') == 'rtl' ? 'breadcrumb-item-rtl ps-0' : '' }} active" aria-current="page">{{ trans('labels.cart') }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="cart-view my-5">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="order-list mb-4">
                        <div class="row align-items-center">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-auto d-none d-md-flex justify-content-center item-img-none">
                                <div class="item-img">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                        ...
                        <div class="row justify-content-between align-items-center">
                            ...
                            <form action="{{ URL::to('/promocodes/apply') }}" method="post">
                                ...
                                <div class="d-flex">
                                    ...
                                    <button type="submit" class="btn btn-primary bg-primary border-0 {{ session()->get('direction') == 'rtl' ? 'me-2' : 'ms-2' }}">{{ trans('labels.apply') }}</button>
                                </div>
                                @error('offer_code')
                    ...
                    <button class="btn btn-success w-100" onclick="isopenclose('{{ URL::to('/isopenclose') }}','{{$total_item_qty}}','{{$order_total}}')">{{ trans('labels.continue') }}</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-grid gap-2 d-flex justify-content-start social-share-icon">
                                        <a class="btn btn-secondary bg-danger border-0 w-100 p-3" href="javascript:void(0)" onclick="showlogin()" type="button">
                                            <i class="fa-solid fa-user-plus"></i>
                                            <span class="px-2">{{ trans('labels.create_account') }}</span>
                                        </a>
                                        <a class="btn btn-outline-success w-100 p-3" href="javascript:void(0)" onclick="holduser(this)" data-url="{{ URL::to('/holduser') }}" data-next-url="{{ route('checkout') }}" type="submit">
        ...
        <div class="modal-content border-0">
            <div class="modal-body py-0 px-4 rounded">
                ...
                <div class="card my-4 border-0">
                    <div class="card-body p-0 {{session()->get('direction') == 'rtl' ? 'pe-3' : 'ps-3'}}">
                        <div class="coupon bg-white rounded d-flex justify-content-between">
                            ...
                            <div class="{{session()->get('direction') == 'rtl' ? 'left-side-rtl' : 'right-side'}}">
                                <div class="info m-3 d-flex align-items-center">
                                    <span class="{{session()->get('direction') == 'rtl' ? 'coupn-circle-up-rtl' : 'coupn-circle-up'}}"></span>
                                    <span class="{{session()->get('direction') == 'rtl' ? 'coupn-circle-down-rtl' : 'coupn-circle-down'}}"></span>
                                    <div class="w-100 d-flex flex-column align-items-center">
                                        ...
                                        <button class="btn btn-sm btn-outline-primary btn-block" onclick="getoffercode('{{ $promocode->offer_code }}')" data-bs-dismiss="modal">{{ trans('labels.copy') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
