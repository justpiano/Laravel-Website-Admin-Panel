                    ...
                    <div class="user-content-wrapper">
                        ...
                        <form action="{{ URL::to('/changepassword') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        <label for="" class="form-label mb-0">{{ trans('labels.confirm_password') }}</label>
                                ...
                                <div class="col-12 {{ session()->get('direction') == 'rtl' ? 'text-start' : 'text-end' }}">
                                    <button @if (env('Environment') == 'sendbox') type="button" onclick="myFunction()" @else type="submit" @endif class="btn btn-primary">{{ trans('labels.reset') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
