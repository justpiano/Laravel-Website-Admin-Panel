                    ...
                    <div class="user-content-wrapper">
                        <p class="title">{{ trans('labels.order_details') }}
                            @if ($orderdata->status == 1)
                                <a class="btn btn-danger btn-sm mx-1 float-end" href="javascript:void(0)" onclick="cancelorder('{{$orderdata->order_number}}','{{URL::to('/orders/cancel')}}')">{{ trans('labels.cancel_order') }}</a>
                            @endif
                        </p>
