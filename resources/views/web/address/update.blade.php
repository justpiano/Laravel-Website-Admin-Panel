                        ...
                        @endif
                            ...
                            @if(!Auth::user())
                                ...
                                <div class="col-12 text-end">
                                    <button class="btn btn-success" @if (env('Environment') == 'sendbox') type="button" onclick="myFunction()" @else type="submit" @endif>{{ trans('labels.save_address_details') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
